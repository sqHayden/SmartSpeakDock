...
public interface SlotsTypes {
    ...
    String USER_FESTIVAL_NAME = "user_festival_name";
    /**
     * 音乐
     */
     ...
     * 地图
     */
    //String USER_MAP_SEARCH_AREA = "user_map_search_area";
    String USER_MAP_SEARCH_NAME = "user_map_search_name";
    String USER_MAP_PATH_WAY = "user_map_path_way";
    String USER_PATH_FROM_NAME = "user_path_from_name";
    String USER_PATH_TO_NAME = "user_path_to_name";
    ...
    String USER_WEATHER_WHICH = "user_wetaher_which";
