package com.idx.smartspeakdock.map.bus;
...
import com.idx.smartspeakdock.map.overlay.BusRouteOverlay;
import com.idx.smartspeakdock.map.util.AMapUtil;
...
public class BusRouteDetailActivity extends Activity implements OnMapLoadedListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.map_activity_route_detail);
