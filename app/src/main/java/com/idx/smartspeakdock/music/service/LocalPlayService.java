...
//                LocalBroadcastManager.getInstance(LocalPlayService.this).sendBroadcast(intent);
//            }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (action) {
            ...
            case PLAY_ACTION:
                ...
                Intent notificationIntent = new Intent(this, LocalPlayService.class);
                ...
                bundle.putBoolean(LocalPlayService.AUDIO_PLAY_NOW_BOOL, playNow);
